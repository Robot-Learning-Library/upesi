...
if __name__ == '__main__':
    ...
    model_list = {
                ...
                # 'no_dr': '20201230_2225', 
                # 'dr': '20201230_1735',
                # 'up': '20201230_2039', '20201231_1521'
                # 'up_embedding': '20210101_2101',
                ...
                # 'up': '20210106_2253',
                'up_si': '20210106_2253',
                # 'up_embedding': '20210104_2229',
                # 'up_embedding_true': '20210104_2229',  # no BO but get the embedding through encoder given true parameters
    ...
    for name, model in model_list.items():
        ...
        for idx in range(10):  # index of sample to test: 0-10
            ...
            data.append(rewards)
        log[name]=data
    np.save('../data/compare_methods/{}/compare_log2.npy'.format(env_name), log)